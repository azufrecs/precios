                    ...
                    <div class="col-md-8" align="center">
                        ...
                        <div class="row">
                            <div class="col-md-12" align="right">
                                <a class='class="w-25 btn btn-lg btn-warning' href='index.php' role='button'>&nbsp;&nbsp;&nbsp;Reiniciar proceso&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;<button class="btn btn-lg btn-primary" type="submit" name="head2">&nbsp;&nbsp;&nbsp;Siguiente&nbsp;&nbsp;&nbsp;</button>
                        </div>
                    </div>
